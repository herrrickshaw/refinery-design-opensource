...
YEARS_GRM = ["2017-18", "2018-19", "2019-20", "2020-21", "2021-22", "2022-23"]
# PPAC Table 4.7, $/bbl. None = not available. 2022-23 provisional.
GRM = {
    "IOCL": [8.49, 5.41, 0.08, 5.64, 11.25, 19.52], "BPCL": [6.85, 4.58, 2.50, 4.06, 9.09, 20.24],
    "HPCL": [7.40, 5.01, 1.02, 3.86, 7.19, 12.09], "CPCL": [6.42, 3.70, -1.18, 7.14, 8.85, 12.48],
    "MRPL": [7.54, 4.06, -0.23, 3.71, 8.72, 9.88], "NRL": [31.92, 28.11, 24.55, 37.23, 43.46, 35.82],
    "BORL": [11.70, 9.80, 5.60, 6.20, 11.00, None], "RIL": [11.60, 9.20, 8.90, None, None, None],
    "NEL": [8.95, 6.97, 5.88, None, None, None], "Singapore": [7.23, 4.88, 3.25, 0.53, 4.99, 10.76],
}
YEARS_DIST = ["2018-19", "2019-20", "2020-21", "2021-22", "2022-23"]
# PPAC Table 4.8, distillate % (2022-23 provisional)
DIST = {
    "Barauni": [87.9, 86.9, 87.1, 85.9, 83.8], "Koyali": [81.0, 79.5, 72.1, 76.7, 74.0],
    "Haldia": [69.9, 69.0, 72.2, 72.2, 74.8], "Mathura": [76.1, 75.6, 72.3, 74.9, 71.8],
    "Panipat": [82.8, 84.8, 80.2, 83.9, 78.9], "Guwahati": [81.0, 83.5, 82.1, 86.4, 81.5],
    "Digboi": [75.8, 72.5, 67.9, 79.2, 72.8], "Bongaigaon": [84.8, 80.8, 84.8, 81.3, 80.0],
    "Paradip": [80.8, 80.7, 79.2, 79.6, 79.5], "Manali": [75.3, 77.6, 78.4, 74.9, 78.3],
    "HPCL Mumbai": [77.6, 77.0, 76.2, 70.4, 75.9], "Visakh": [74.5, 72.1, 74.4, 70.7, 67.9],
    "BPCL Mumbai": [82.2, 84.9, 83.7, 84.4, 85.5], "Kochi": [82.5, 84.2, 83.8, 85.4, 83.9],
    "Bina": [None, None, None, 84.3, 85.3], "Numaligarh": [87.1, 83.0, 86.4, 85.7, 89.9],
    "Mangalore": [76.8, 76.7, 78.1, 78.8, 77.9], "PSU average": [79.6, 80.0, 78.6, 79.6, 78.7],
}
# PPAC Table 4.9 fuel & loss, % of crude+other inputs: Paradip by year 2017-18..2022-23; PSU total 2022-23
FUEL_LOSS = {"Paradip_pct": [10.9, 9.8, 9.6, 11.0, 11.0, 10.0],
